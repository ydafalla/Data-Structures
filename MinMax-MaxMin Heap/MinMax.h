...
public:
  ...
  //This is a method for building the heap
  //pre: The function has no input
  //post: The functions builds the heap using the bottom up approach
  //return: The function has no return value
  void Buildheap();

  //This is a method used in pathcing when building heap bottom up approach
  //pre: The function receives an input which is the position of the hole
  //post: The function patches the hole in the Buildheap
  //return: The function has no return value
  void Patch1(int);

  //This is a method used in patching when building heap bottom up approach
  //pre: The function receives an input which is the position of the hole
  //post: The function patches the hole in the Buildheap
  //return: The function has no return value
  void Patch2(int);
  ...
  //This is a method for deleting the minimum element in the minmax heap
  ...
  //This is a method for finding the second smallest element in the minmax heap
  ...
  //This is a method for finding the minimum element in the minmax heap
  //pre: The function has no input value
  //post: The function prints the minimum value in the heap
  //return: The function has no return value
  void FindMin();

  //This is a method for finding the maximum element in the minMax heap
  //pre: The function has no input value
